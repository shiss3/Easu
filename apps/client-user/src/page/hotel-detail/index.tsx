// apps/client-user/src/pages/HotelDetail/index.tsx
import { useEffect, useState } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { ChevronLeft, Share2, Heart, MoreHorizontal } from 'lucide-react';
import { getHotelDetailApi, type HotelDetailVo } from '@/services/hotel-detail';
...
const HotelDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20 relative">
            ...
            {/* 底部浮动栏 - 显示最低价或预订概览 */}
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 flex justify-between items-center z-50 safe-area-bottom">
